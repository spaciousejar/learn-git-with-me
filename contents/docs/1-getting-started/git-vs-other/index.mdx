...
![Git vs Other VCS](/images/docs/1-getting-started/git-vs-other-vcs.svg)

Understanding how Git compares to other version control systems helps you appreciate its strengths and why it has become the industry standard.
