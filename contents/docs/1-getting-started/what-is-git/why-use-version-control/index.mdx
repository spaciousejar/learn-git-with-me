...
description: Understand the benefits and importance of using version control systems in software development
---
...
<Outlet path="1-getting-started/what-is-git/why-use-version-control" />
