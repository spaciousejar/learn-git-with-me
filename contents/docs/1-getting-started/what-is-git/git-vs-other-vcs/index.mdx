...
description: Compare Git with other version control systems and understand its advantages
---
...
- <Link href="https://git-scm.com/about">Why Git?</Link>
...
<Outlet path="1-getting-started/what-is-git/git-vs-other-vcs" />
