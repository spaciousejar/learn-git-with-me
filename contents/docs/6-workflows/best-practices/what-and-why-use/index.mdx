...
description: Learn about What And Why Use in Git
---
...
- <Link href="https://www.youtube.com/results?search_query=git+what-and-why-use+tutorial">Video Tutorials</Link>
</TabsContent>
</Tabs>

<Outlet path="6-workflows/best-practices/what-and-why-use" />
