...
---
title: Git Rebase
description: Learn how to use git rebase to maintain a clean, linear project history
---
...
<TableHeader>
<TableRow>
<TableHead>Rewrites commit history</TableHead>
<TableHead>Preserves commit history</TableHead>
</TableRow>
</TableHeader>
<TableBody>
<Table>
<TableHeader>
<TableRow>
<TableHead>Creates a linear history</TableHead>
<TableHead>Creates a branched history with merge commits</TableHead>
</TableRow>
</TableHeader>
<TableBody>
<Table>
<TableHeader>
<TableRow>
<TableHead>Better for local branches before sharing</TableHead>
<TableHead>Better for public/shared branches</TableHead>
</TableRow>
</TableHeader>
<TableBody>
<Table>
<TableHeader>
<TableRow>
<TableHead>Can cause conflicts that need manual resolution</TableHead>
<TableHead>Can also cause conflicts but preserves the branch structure</TableHead>
</TableRow>
</TableHeader>
<TableBody>
...
<Outlet path="6-workflows/models/git-rebase" />
