...
- <Link href="https://github.com/newren/git-filter-repo">git filter-repo</Link>git filter-branch</Link>
</Note>
</TabsContent>
<TabsContent value="article">
<Note type="note" title="article">
- <Link href="https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/removing-sensitive-data-from-a-repository">Atlassian Git Tutorials</Link>Removing sensitive data from a repository</Link>
</Note>
</TabsContent>
