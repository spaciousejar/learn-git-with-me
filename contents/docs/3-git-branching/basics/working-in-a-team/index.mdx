...
- <Link href="https://www.youtube.com/results?search_query=git+working-in-a-team+tutorial">Video Tutorials</Link>
</TabsContent>
</Tabs>

<Outlet path="3-git-branching/basics/working-in-a-team" />
