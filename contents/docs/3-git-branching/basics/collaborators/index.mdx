...
- <Link href="https://docs.github.com/en/organizations/managing-user-access-to-your-organizations-repositories/managing-outside-collaborators/adding-outside-collaborators-to-repositories-in-your-organization">Adding outside collaborators to repositories in your organizationHow to add collaborators to your personal projects</Link>
</Note>
</TabsContent>
<TabsContent value="article">
<Note type="note" title="article">
- <Link href="https://www.blinkops.com/blog/how-to-add-collaborators-to-your-github-repository">Atlassian Git TutorialsHow to Add Collaborators to Your GitHub Repository</Link>
</Note>
</TabsContent>
