...
- <Link href="https://docs.github.com/en/get-started/using-git/pushing-commits-to-a-remote-repository">Pushing commits to a remote repositoryGit Branching - Basic Branching and Merging</Link>
</Note>
</TabsContent>
<TabsContent value="article">
<Note type="note" title="article">
- <Link href="https://education.github.com/git-cheat-sheet-education.pdf">Atlassian Git TutorialsGit ignore</Link>
</Note>
</TabsContent>
