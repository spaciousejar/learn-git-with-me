...
description: Learn about Git Stash Basics in Git
---
...
- <Link href="https://www.atlassian.com/git/tutorials/saving-changes/git-stash">Git stash</Link>
- <Link href="https://opensource.com/article/21/4/git-stash">A practical guide to using the git stash command</Link>

</TabsContent>
<TabsContent value="video">
- <Link href="https://www.youtube.com/results?search_query=git+git-stash-basics+tutorial">Video Tutorials</Link>
</TabsContent>
</Tabs>

<Outlet path="4-git-advanced/tools/git-stash-basics" />