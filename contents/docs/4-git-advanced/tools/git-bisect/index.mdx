...
- <Link href="https://dev.to/alvesjessica/using-git-bisect-to-find-the-faulty-commit-25gf">Atlassian Git TutorialsUsing `git bisect` to find the faulty commit</Link>
</Note>
</TabsContent>
