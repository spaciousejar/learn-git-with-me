...
- <Link href="https://medium.com/@KeyurRamoliya/git-use-tags-for-versioning-and-release-management-09aca9631eee">Atlassian Git Tutorials</Link>Git — Use Tags for Versioning and Release Management</Link>
</Note>
</TabsContent>
