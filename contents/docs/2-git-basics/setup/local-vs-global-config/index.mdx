...
- <Link href="https://www.youtube.com/results?search_query=git+local-vs-global-config+tutorial">Video Tutorials</Link>
</TabsContent>
</Tabs>

<Outlet path="2-git-basics/setup/local-vs-global-config" />
