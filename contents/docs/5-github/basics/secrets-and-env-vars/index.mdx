...
- <Link href="https://docs.github.com/en/actions/writing-workflows/choosing-what-your-workflow-does/store-information-in-variables">Store information in variables</Link>Using secrets in GitHub Actions</Link>
</Note>
</TabsContent>
