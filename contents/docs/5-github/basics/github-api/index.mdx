...
- <Link href="https://docs.github.com/en/rest/using-the-rest-api/getting-started-with-the-rest-api?apiVersion=2022-11-28">Atlassian Git Tutorials</Link>Getting Started</Link>
</Note>
</TabsContent>
