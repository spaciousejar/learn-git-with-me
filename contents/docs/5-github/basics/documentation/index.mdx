...
- <Link href="https://dev.to/mochafreddo/how-to-manage-documentation-in-a-github-repository-a-guide-for-junior-developers-pgo">Atlassian Git TutorialsHow to Manage Documentation in a GitHub Repository: A Guide for Junior Developers</Link>
</Note>
</TabsContent>
