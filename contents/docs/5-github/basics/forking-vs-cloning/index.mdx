...
- <Link href="https://www.theserverside.com/answer/Git-fork-vs-clone-Whats-the-difference">Atlassian Git Tutorials</Link>Git fork vs. clone: What's the difference?</Link>
</Note>
</TabsContent>
